import { pgTable, text, timestamp, integer, jsonb, foreignKey } from "drizzle-orm/pg-core";
...
export const courthouses = pgTable("courthouses", {
	id: integer("id").primaryKey().generatedByDefaultAsIdentity({ name: "courthouses_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
